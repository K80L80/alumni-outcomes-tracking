...
public class Main
{
	...
	{
		final ObjectInputFilter.Config c = new ObjectInputFilter.Config();

		final ImportProject importProject = new ImportProject(c);
		importProject.doPost();

		//final ImportInstrumentEventMaps importInstrumentEventMaps = new ImportInstrumentEventMaps(c);
		...
		//final ImportEvents importEvents = new ImportEvents(c);
		//importEvents.doPost();
